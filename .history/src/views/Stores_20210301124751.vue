    ...
    <a-col :xs="{ span: 20 }">
      <a-tabs default-active-key="1" tab-position="top">
        <a-tab-pane key="1" tab="NAOS">
          <a-layout>
            <a-layout-header style="background:white; height:200px; ">
              <a-row>
                <a-col :span="12"> </a-col>
                <a-col :span="12">
                  <a-form-item
              ...
              <a-row style="width:100%; padding-bottom:1rem; background:red;">
                <a-col
                  :span="24"
                  style=" text-align:center; display:flex; justify-items:center;background:blue; "
                >
                  <p>
