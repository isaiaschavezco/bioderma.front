    ...
    >
      <a-form :form="fileFormCampaing">
        ...
        <a-form-item class="modal-validity__form">
          ...
          <span>AL</span>
          <br />
          :disabledDate="disabledEndValidityDate" :show-time="{ defaultValue:
          moment('00:00:00', 'HH:mm:ss') }" format="DD-MM-YYYY HH:mm:ss"
          placeholder="Fin trivia" v-model="endValidityDate" :open="endOpenDate"
