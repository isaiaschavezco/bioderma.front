    ...
    <a-col :xs="{ span: 20 }">
      <a-tabs default-active-key="1" tab-position="top">
        <a-tab-pane key="1" tab="NAOS">
          <a-layout>
            <a-layout-header style="background:white; height:80px; ">
              <a-row>
                <a-col :span="12"> </a-col>
                <a-col :span="12">
                  <a-form-item
              ...
              <a-row>
                <a-col :span="24" style="background:gray; text-align:center;">
                  Actualmente no tienes una campaña activa, ingresa al apartado
                  "Campañas" para generar una nueva.
                </a-col>
              </a-row>
            </a-layout-header>
