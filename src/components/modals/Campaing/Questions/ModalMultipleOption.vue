      ...
      >
        ...
        >
          <a-col class="form-question__option" span="24">
            ...
            <a-col span="1" class="option__labelOption">{{ `${option.indicator})` }}</a-col>
            <a-col span="21">
              <a-form-item>
                <a-input
...
export default {
  ...
  watch: {
    ...
    questionJSON: function() {
      ...
      if (this.questionJSON.content && this.questionJSON.answer) {
        ...
        // console.log("this.answer:", this.questionJSON.answer.response);
  ...
  methods: {
    ...
    /* onChangeAnswer() {
      console.log("this.answer DOS: ", this.answer);
      ...
      if (!this.isAvailableOption[this.answer] || option.length == 0) {
        for (let i = 4; i >= 0; --i) {
          if (
            i < 2 ||
            (this.isAvailableOption[i] && this.optionsValues[i].length > 0)
          ) {
            console.log("Nuevo valor: ", i);
            this.answer = i;
            break;
          }
        }
