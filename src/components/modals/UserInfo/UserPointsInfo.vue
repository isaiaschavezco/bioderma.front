  ...
  <a-col span="16" class="user-points-info">
    <div class="points-info points-info-total-points">
      <a-row>
        ...
        <a-col span="12">
          <span
            class="points-info-amount total-points-user points-info-user-amount"
            >{{ dataPoints.total }}</span
          >
        </a-col>
      </a-row>
    </div>
    <div class="points-info points-info-total-points">
      <a-row>
        ...
        <a-col span="12">
          <a-row>
            <a-col span="6">
              <span class="points-info-amount points-info-user-amount">{{
                dataPoints.biodermaGame
              }}</span>
            </a-col>
